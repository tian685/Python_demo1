...
from FullCode_PythonQt.chap08Graphics.Demo8_6GraphicsDraw.myGraphicsView import QmyGraphicsView

from FullCode_PythonQt.chap08Graphics.Demo8_6GraphicsDraw.ui_MainWindow import Ui_MainWindow
