...
from FullCode_PythonQt.chap12QtChart.Demo12_7FillArea.ui_MainWindow import Ui_MainWindow

from FullCode_PythonQt.chap12QtChart.Demo12_7FillArea.myChartView import QmyChartView
