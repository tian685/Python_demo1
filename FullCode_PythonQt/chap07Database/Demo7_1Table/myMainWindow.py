...
from FullCode_PythonQt.chap07Database.Demo7_1Table.ui_MainWindow import Ui_MainWindow

from FullCode_PythonQt.chap07Database.Demo7_1Table.myDelegates import QmyComboBoxDelegate
...
##界面组件与tabModel的具体字段之间的联系
      ...
      #self.ui.tableView.setColumnHidden(self.fldNum["Name"],  True)  #隐藏列
