...
from PyQt5.QtWidgets import  (QApplication, QMainWindow, QWidget,
                  QSplitter, QColorDialog,QInputDialog,QLineEdit,QMessageBox)
...
from FullCode_PythonQt.chap13DataVisualization.Demo13_3Surface.ui_MainWindow import Ui_MainWindow
...
##  ==============自定义功能函数========================
   def __iniGraph3D(self):    ##创建3D图表
      ...
      self.graph3D.activeTheme().setLabelBackgroundEnabled(True)
