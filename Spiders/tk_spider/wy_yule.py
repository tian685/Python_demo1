...
conn = connect(host='localhost', port=3306, database='world', user='root', password='自己的密码', charset='utf8')
# 获取cursor对象
cs1 = conn.cursor()
#存mysql函数
...
def get_wy_yule():
    url = 'https://ent.163.com/special/000380VU/newsdata_index.js?callback=data_callback'
    headers = {
